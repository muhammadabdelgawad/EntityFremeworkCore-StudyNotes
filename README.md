...
Currently, this repository contains a minimal "Hello, World!" console application.  Future additions will include:
...
*   Advanced EF Core features (e.g., change tracking, disconnected scenarios).
